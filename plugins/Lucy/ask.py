...
async def gpt_handler(client: Client, message: Message):
    try:
        ...
        if len(message.command) < 2:
            await message.reply_text(f"<b>Hello {name}, I am ʏɴᴠᴍᴏᴠɪᴇs . How can I help you today?</b>")
            return
...
async def chat_annie(client: Client, message: Message):
    try:
        ...
        if len(message.command) < 2:
            await message.reply_text(f"<b>Hello {name}, I am ʏɴᴠᴍᴏᴠɪᴇs. How can I assist you today?</b>")
            return
